...
class ProdBuilder extends _baseBuilder2.default {
    ...
    build() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            let { build, globals } = _this.config;

            // clear dist/ first
            _logger2.default.info('build', `start clearing ${build.path}...`, true);
            yield (0, _fsExtra.emptyDir)(build.path);
            _logger2.default.info('build', `${build.path} cleared.`, true);

            _logger2.default.info('build', 'start compiling routes...', true);
            yield _this.routeManager.buildRoutes();
            _logger2.default.info('build', 'compiling routes completed.', true);

            _logger2.default.info('build', 'start writing files to /.lavas...', true);
            yield _promise2.default.all([_this.writeRuntimeConfig(), _this.writeMiddleware(), _this.writeStore()]);
            _logger2.default.info('build', 'writing files to /.lavas completed', true);
