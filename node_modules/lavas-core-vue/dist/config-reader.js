...
class ConfigReader {
    ...
    read() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            if (_this.customConfigPath) {
                _logger2.default.info('build', `read custom config: ${_this.customConfigPath}...`, true);
            ...
            if (yield (0, _fsExtra.pathExists)(singleConfigPath)) {
                _logger2.default.info('build', 'read lavas.config.js...', true);
                ...
                _logger2.default.info('build', 'reading config completed.', true);
                return config;
            }

            // read from config/
            _logger2.default.warn('build', 'config directory is deprecated! Try to use lavas.config.js instead.');
    ...
    readConfigFile() {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            _logger2.default.info('build', 'start reading config...', true);
