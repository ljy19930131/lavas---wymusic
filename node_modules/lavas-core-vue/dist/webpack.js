...
class WebpackConfig {
    ...
    client(internalBuildConfig = {}) {
        ...
        return (0, _asyncToGenerator3.default)(function* () {
            ...
            if (_this2.isProd && serviceWorker) {
                // Copy workbox.dev|prod.js from node_modules manually.
                copyList = copyList.concat((0, _workbox.getWorkboxFiles)(_this2.isProd).map(function (f) {
                    return {
                        from: (0, _path.join)(_workbox.WORKBOX_PATH, `../${f}`),
                        to: (0, _path2.assetsPath)(`js/${f}`)
                    };
                }));
