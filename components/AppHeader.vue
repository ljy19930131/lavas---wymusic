<template>
    <transition
        name="slide-down">
        <header class="app-header-wrapper" v-show="show" :style="bgOpacity?'background:rgba(0,0,0,0)':''">
...
.app-header-wrapper
    ...
    color $btn-color
    padding 0
    // box-shadow 0 2*$rem 4*$rem -1*$rem rgba(0,0,0,.2), 0 4*$rem 5*$rem rgba(0,0,0,.14), 0 1*$rem 10*$rem rgba(0,0,0,.12)
